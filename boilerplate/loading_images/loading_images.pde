...
void setup() {
  ...
  pic=loadImage("45bc20c2dc62238278e88d8d55c17536--bottle-hatsune-miku.jpg");//dimensions: 582 width, 900 height
  ...
  rect(width*1/4, height*2/16, width*1.164, height*1.5);
