...
void setup() {
  ...
  pic=loadImage("78dc56f63d0c768b0f4b2c3d83827e3b.jpg");//dimensions: 1080 width, 1920 height
  //pic2=loadImage("45bc20c2dc62238278e88d8d55c17536--bottle-hatsune-miku.jpg");//dimensions: 582 width, 900 height
  //pic3=loadImage("9e6cf9a3c0b5f89952c50b8f0f915e3f.png");//dimensions: 420 width, 420 height'
  
  rect(125, 175, 225, 225);
  //image();
}
